...
const STATIC_PATHS: Array<{ path: string; changefreq: string; priority: number }> = [
  ...
  { path: "/learn/the-rejection-short-setup", changefreq: "monthly", priority: 0.7 },
  { path: "/learn/how-to-trade-the-daily-plan", changefreq: "monthly", priority: 0.7 },
  { path: "/learn/the-failed-breakdown-setup", changefreq: "monthly", priority: 0.7 },
  { path: "/learn/acceptance-and-level-to-level", changefreq: "monthly", priority: 0.7 },
